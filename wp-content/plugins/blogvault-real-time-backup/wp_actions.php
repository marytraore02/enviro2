	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '9c70f46a23e9f5b0388d1a0dabb5c57c', '14f048f6b2e8fffc1b9a5e215f341e47');
		BVAccount::updateApiPublicKey($this->settings, '9c70f46a23e9f5b0388d1a0dabb5c57c');
			}
